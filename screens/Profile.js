                  ...
                  onPress: (password) => {
                    ...
                    userCredential
                      ...
                      .catch((error) => {
                        ...
                        Alert.alert(
                          "Error",
                          "You entered a wrong password for this account "
                        );
                      });
                  },
                },
  ...
  return (
        ...
        <View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.sectionContent}>
              ...
              <Text style={styles.sectionContentText}>
                Registered date:{" "}
                {creationTime && new Date(creationTime).toDateString()}
              </Text>
              <Text style={styles.sectionContentText}>
                Latest Sign in date:{" "}
                {lastSignInTime && new Date(lastSignInTime).toDateString()}
              </Text>
   ...
   <Text style={styles.sectionContentText}>Email:                      {email}</Text> */}
                ...
                <Button
                  ...
                  onPress={async () => {
                    try {
                      const result = await Share.share({
                        message:
                          "Check out this awesome app called UTGBusTracking in the Play Store & App Store!",
                        title: "Invite a friend",
                      });
          ...
          <View style={styles.buttonContainer}>
            <View
              style={{ padding: 10, backgroundColor: "white", marginTop: -30 }}
            >
              <Button
                    ...
                    .then(() => {
                      ...
                      user
                        ...
                        .catch((error) => {
                          // Show error message
                          alert(
                            "An Email will be send to you to change your password"
                          );
                        });
                    })
                    .catch((error) => {
                      // Show error message
                      alert(
                        "An Email has been send to you to change your password"
                      );
                    });
                }}
