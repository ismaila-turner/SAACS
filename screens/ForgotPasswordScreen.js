...
const ForgotPasswordScreen = () => {
  ...
  return (
    <View >
      ...
      <TextInput style={{margin:50, fontSize:20, alignSelf:'center',borderWidth:1,width:300, height:50,padding:10,borderColor:'gray',backgroundColor:'lightgray',borderRadius:10}}
