...
import PromptAndroid from './PromptAndroid';
  ...
  const share = async () => {
    try {
        const result = await Share.share({
          url: 'https://play.google.com/store/apps/details?id=com.nekgambia.app',
...
function deleteUserAccount() {
  ...
  return (
    <ScrollView>
        ...
        <TouchableOpacity onPress={() => alert('New houses and lands are available for sale! Check The buy House Section And Lands ')}>
          <Text  style={styles.textstyle}  >Check For Latest Information</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Search')}>
          <Text  style={styles.textstyle} >Search Preferences</Text>
          </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Private Policies')}>
        ...
        <TouchableOpacity  onPress={() => navigation.navigate('Delete User Account')}>
