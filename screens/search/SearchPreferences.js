...
const SearchPreferences=({navigation})=> {
  ...
  return (
    ...
    <ScrollView style={styles.container}>
     ...
     <View  >
        <Text  style={{fontSize:20, textAlign:'center', fontWeight:'bold', margin:10,padding:10, textTransform:'capitalize' }} >
          Select the specific area you want to search 
            </Text> 
<View>
      <TouchableOpacity onPress={()=>navigation.push('Buy House') }>
<Text  style={{fontSize:20, color:'blue' ,  margin:10,padding:5}} > Search to Buy Home </Text>
</TouchableOpacity>

<TouchableOpacity onPress={()=>navigation.push('Rent House') }>
<Text   style={{fontSize:20, color:'blue' ,  margin:10,padding:5}}  > Search to Rent House </Text>
</TouchableOpacity>
<TouchableOpacity onPress={()=>navigation.push('Rent Apartment') }>
<Text  style={{fontSize:20, color:'blue' ,  margin:10,padding:5}}  > Search to Rent Apartment </Text>
</TouchableOpacity>
<TouchableOpacity onPress={()=>navigation.push('rent a Shop') }>
<Text  style={{fontSize:20, color:'blue' ,  margin:10,padding:5}}  > Search to Rent a shop </Text>
</TouchableOpacity>
<TouchableOpacity onPress={()=>navigation.push('Buy a Land') }>
<Text  style={{fontSize:20, color:'blue' ,  margin:10,padding:5}}  > Search to Buy Land </Text>
</TouchableOpacity>
<TouchableOpacity onPress={()=>navigation.push('Sold Houses') }>
<Text  style={{fontSize:20, color:'blue' ,  margin:10,padding:5}}  > Search For Sold Houses </Text>
</TouchableOpacity>
<TouchableOpacity onPress={()=>navigation.push('Sold Lands') }>
<Text style={{fontSize:20, color:'blue' ,  margin:10,padding:5}}  > Search For Sold Lands </Text>
</TouchableOpacity>
</View>
